...
class HeaderPaymentRange extends StatefulWidget {
  final ScreenSize screenSize;
  final PaymentsProvider paymentsProvider;
  const HeaderPaymentRange(
      {Key? key, required this.screenSize, required this.paymentsProvider})
      : super(key: key);

  @override
  State<HeaderPaymentRange> createState() => _HeaderPaymentRangeState();
}

class _HeaderPaymentRangeState extends State<HeaderPaymentRange> {
  @override
